...
<title>Login - STF Car Interior Design</title>
...
.login_box {
    position:relative; z-index:2; width:450px; background:rgba(26,26,46,0.85);
    backdrop-filter:blur(20px); border:1px solid rgba(212,175,55,0.3); border-radius:25px;
    padding:50px 40px; box-shadow:0 25px 60px rgba(0,0,0,0.5);
}
form h2 {
...
.inputbox i {
    position:absolute; right:10px; top:15px; color:#b8b8b8; cursor:pointer;
...
.links a {
    color:#b8b8b8; font-size:0.9rem; text-decoration:none; transition:color 0.3s ease;
}
